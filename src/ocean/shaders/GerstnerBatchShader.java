...
public class GerstnerBatchShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = "src/ocean/shaders/gerstnerBatchVertex.txt";
	private static final String FRAGMENT_FILE = "src/ocean/shaders/gerstnerBatchFragment.txt";

...
public class OceanShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = "src/ocean/shaders/oceanVertex.txt";
	private static final String FRAGMENT_FILE = "src/ocean/shaders/oceanFragment.txt";

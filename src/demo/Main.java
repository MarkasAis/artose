...
public class Main {
	...
	public static void main(String[] args) {
		...
		ComputeManager.createContext();
		Input.initListener();
		System.out.println(GL30.glGetString(GL30.GL_VERSION));
		
		Skybox[] skyboxes = new Skybox[] {
			Skybox.load("res/epic_pink", new Vector3f(0.706f, 0.639f, 0.722f), MathUtils.rotationToDirection(new Vector3f(-0.05f, 0f, 0f))),
			Skybox.load("res/moon_burst", new Vector3f(0.098f, 0.121f, 0.158f), MathUtils.rotationToDirection(new Vector3f(-0.1f, 0f, 0f))),
			Skybox.load("res/epic_sunset", new Vector3f(0.231f, 0.349f, 0.541f), MathUtils.rotationToDirection(new Vector3f(-0.05f, 0f, 0f))),
			Skybox.load("res/sunset", new Vector3f(0.29f, 0.161f, 0.161f), MathUtils.rotationToDirection(new Vector3f(-0.5f, -0.1f, 0f))),
			Skybox.load("res/overcast2", new Vector3f(0.95f, 0.95f, 0.95f), MathUtils.rotationToDirection(new Vector3f(-1.57f, 0f, 0f))),
			Skybox.load("res/space", new Vector3f(0.098f, 0.121f, 0.158f), MathUtils.rotationToDirection(new Vector3f(-0.05f, 0f, 0f)))
		};
